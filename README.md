...
What it does
Skilling Loot Tracker runs silently while you skill and automatically logs every item you obtain from Fishing, Mining, Woodcutting, Farming, and Hunter. No setup, no spreadsheets. Real loot data, GP/hr, and session stats built straight into RuneLite with full persistence between logins.
